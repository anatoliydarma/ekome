...
<div class="relative">
	...
	<div
		class="{open ? 'translate-x-0' : 'translate-x-full'}
            fixed top-0 right-0 z-50 h-screen text-stone-700 dark:text-surface-300 transition-all duration-700 ease-in-out transform bg-white dark:bg-surface-800 w-full max-w-screen-md"
	>
